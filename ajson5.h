...
//2017-12-16
//ArduinoJson::JsonVariant wft_getJsonVarFromFile(std::string filepath)
//{
//	//this codes below can not be passed out of this enclope. you need to copy codes into your cpp files.
//	std::ifstream ifs(filepath.c_str());
//	ArduinoJson::DynamicJsonBuffer jsonBuffer;
//	ArduinoJson::JsonVariant root = jsonBuffer.parseObject(ifs);
//	std::string smask = root["shengmask"];
//  bool has = root.containsKey("some");
//	return root;
//}
